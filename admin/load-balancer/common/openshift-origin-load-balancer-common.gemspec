...
spec_file = "rubygem-openshift-origin-load-balancer-common.spec"

Gem::Specification.new do |s|
  s.name        = "openshift-origin-load-balancer-common"
  ...
  s.files       += %w(README.md Rakefile Gemfile rubygem-openshift-origin-load-balancer-common.spec openshift-origin-load-balancer-common.gemspec LICENSE COPYRIGHT)
  s.require_paths = ["lib"]
